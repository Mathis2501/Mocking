...
namespace Mocking
{
    ...
    public class MockTests
    {
        ...
        {
            //Arrange
            User admin = new User() { UserName = "sist@eal.dk", Password = "!QAZ2wsx" };

            Mock<ILoginModule> mockLogin = new Mock<ILoginModule>();
        ...
        public void AfterMailSentMessageCanBeFoundInEmployeesNumReceivedMessages()
        {
            ...
            Employee e = mock.Object.LoadEmployee(id);
            Mail message = new Mail() { Content = "Hello " + e.Name + " Your paycheck is wrong!" };
